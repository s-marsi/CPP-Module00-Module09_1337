...
AForm::AForm(std::string _name): name(_name), isSigned(false), gradeRequired(30), gradeExecute(5) { }
...
AForm::AForm(AForm &rhs): name(rhs.getName()), isSigned(rhs.getIsSigned()), gradeRequired(rhs.getGraderequired()), gradeExecute(rhs.getGradeExecute()) { *this = rhs; }
